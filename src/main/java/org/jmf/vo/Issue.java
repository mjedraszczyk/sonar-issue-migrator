...
public final class Issue {
  ...
  private String parsedComponent;
  ...
  public String getParsedComponent() {
    if (this.parsedComponent == null) {
      this.parsedComponent = parseComponent(this.component);
    }
    return this.parsedComponent;
  }

  private static String parseComponent(String component) {
    if (component == null) {
      return "";
    }
